...
const SignUp = () => {
  ...
  const initGoogleSignIn = async () => {
    ...
    if (has) {
      GoogleSignin.configure({
        webClientId:
          "1001847642825-rh05l1e0ed7avev5mvdkdgugrk0ejea5.apps.googleusercontent.com",
      });
    }
  };
  useEffect(() => {
  ...
  const onGoogleButtonPress = async () => {
    try {
      ...
      console.log(signInResult, "RESULTTT");
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Sign-in the user with the credential
      let result = await signInWithCredential(auth, googleCredential);
  ...
  const handleFirebaseError = (error) => {
    ...
    switch (error.code) {
      case "auth/invalid-email":
        errorMessage =
          "El correo electrónico no es válido. Verifica el formato.";
        break;
      case "auth/user-not-found":
        errorMessage =
          "No se encontró una cuenta con este correo. Regístrate primero.";
        break;
      ...
      case "auth/invalid-credential":
        errorMessage =
          "Las credenciales ingresadas no son válidas. Intenta nuevamente.";
        break;
  ...
  return (
    <LinearGradient colors={["#1E3A5F", "#3C6E9F"]} style={styles.gradient}>
      <SafeAreaView
        style={[
          styles.safeArea,
          ...
          <View style={styles.container}>
            ...
            <View style={styles.avatarContainer}>
              <View style={styles.avatarOptions}>
                <TouchableOpacity
                  style={[
                    styles.avatarOption,
                    selectedAvatar === "masculino" && styles.selectedAvatar,
                  ]}
                ...
                >
                  <MaterialIcons
                    name="face"
                    size={50}
                    color={selectedAvatar === "masculino" ? "#f59e0b" : "#FFF"}
                  />
                ...
                <TouchableOpacity
                  style={[
                    styles.avatarOption,
                    selectedAvatar === "femenino" && styles.selectedAvatar,
                  ]}
                ...
                >
                  <MaterialCommunityIcons
                    name="face-woman"
                    size={50}
                    color={selectedAvatar === "femenino" ? "#f59e0b" : "#FFF"}
                  />
            ...
            <View style={styles.formContainer}>
              ...
              <View>
                ...
                <SignInComponents handleGoogleSignIn={handleGoogleSignIn} />
              </View>
